...
/*  shin.  관리자 영화상세정보*/
	public MovieBasicInfoDTO updateMovieInfo(String movieTitle, String movieIntro, String movieReleaseDate,
			String movieDirector, String movieAuthor, String movieGenre, String movieCast, int movieAgeLimitText,
