...
public class LoginCookieAddInterceptor extends HandlerInterceptorAdapter {
	// 사용자 로그인시 
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		System.out.println("LoginCookieAddInterceptor");
		...
		if(keepLogin != null) {
			if(keepLogin.equals("check")) {
				...
				System.out.println("LoginCookieAddInterceptor : 쿠키가 추가되었다.");
			}
		}
	}
}
