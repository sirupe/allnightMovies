...
<div class="div-currentFilm-images js_currentFilmSort">
	<c:forEach begin="0" end="${filmNum}" step="1" items="${CurrentFilmDTO }" var="CurrentFilmDTO" varStatus="filmNum" >
		<c:choose>
			<c:when test="${filmNum.count % 3 != 0}">
				<span class="span-currentFilm-images">
					<span class="span-filmImgs  js_currentFilmInOut" style="background-image: url('/../resources/img/poster/${CurrentFilmDTO.moviePoster }');">
						<a class="hiddenText" href="/movie/mainService/movieDetailInfo?movieInfoTitle=${CurrentFilmDTO.movieTitle}&movieNO=${CurrentFilmDTO.no}">상세보기</a>
					</span>
