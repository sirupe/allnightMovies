...
<div class="div-withdraw js_WithdrawContainer">
	...
	<div class="div-withdraw__content">
		...
		<span class="span-withdraw__password">
			<label>비밀번호 입력</label>
			<input class="input-withdraw__password js_WithdrawPasswordInput" name="withdrawUserPwd" type="password" placeholder="비밀번호 입력" />
		</span>
		<span class="span-withdraw__buttons">
			<button class="button-withdraw__withdraw js_WithdrawBtn" type="button">탈퇴하기</button>
			<button class="button-withdraw__reset js_WithdrawMyInfoBtn" type="button">내정보</button>
		</span>
	</div>
</div>