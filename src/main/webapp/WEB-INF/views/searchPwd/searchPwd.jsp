...
<div class="div__searchPwd">
	...
	<div class="div__searchPwd__content">
		...
		<input id="search-userid" class="input__searchPwd__id" type="text" name="searchPwdUserID" placeholder="아이디 입력" autocomplete="off"/>
		<div id="search-userid-result" class="div-search-userid-result"></div>
