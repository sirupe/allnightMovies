...
<div class="reCheckFormContainer">
	...
	<c:if test="${!isManager}">
		...
		<div class="QuestionBoardReCheckPWd_content">
			...
			<input class = "QuestionBoardReCheckPWd_input js_questionBoardReChecked" type="password" style="ime-mode:disabled;" maxlength = 4 onkeyPress="passWordCheck(this)" value="0">
		</div>
